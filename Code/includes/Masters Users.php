		...
		<form method="post" action="?page=<?php echo $_GET['page']."&subpage=".$_GET['subpage']."&pageno=".$_GET['pageno']; ?>" id="form" class="form panel" onsubmit="return validation()">
			...
			<fieldset>
				...
				<div class="clearfix">
					...
					<label>
						User Role <font color="red">*</font><br />
	...
	<div class="columns">
		...
		<table class="paginate sortable full">
			...
			<tbody>
				...
				{
					$Role = mysqli_fetch_assoc(UserRole_Select_ById($User['user_role_id']));
					echo "<tr>
...
<script>
	function isAlphabetic(evt)
	{
		...
		if (charCode == 8 || charCode == 9  || charCode == 46 || (charCode >= 35 && charCode <= 40)) 
			return true;
	...
	{
		var charCode = (evt.which) ? evt.which : evt.keyCode;
		if (charCode == 8 || charCode == 9  || charCode == 45 || charCode == 46 || charCode == 47 || (charCode >= 35 && charCode <= 40)) 
			return true;
		if(charCode > 31 && (charCode < 48 || charCode > 57))
			return false;
	}
	/*  function validateLandLine(id) 
	{
	...
	function validation()
	{
        ...
        if (x.length > 10 || x.length > 8 ){
                message = "enter 10 or 8 characters";
			//return false;
           }
        if (x.charAt(0)!="9" || x.charAt(0)!="2"){
                message = "it should start with 9 or 2 ";
                //return false
           }
